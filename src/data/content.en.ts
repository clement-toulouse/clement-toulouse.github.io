...
export const contentEn: SiteContent = {
  ...
  hero: {
    ...
    locationCard: { title: 'Paris · Rosny-sous-Bois', subtitle: 'Open to a conversation' },
  ...
  aiCards: [
    ...
    {
      kicker: 'Internal AI assistants',
      title: 'Dust',
      body: "I deploy AI assistants (via the Dust platform) connected to the company's documentation and tools, so the right information shows up before anyone has to search for it.",
      points: [
        'Business assistants wired into product documentation',
    ...
    {
      kicker: 'Product process',
      title: 'AI Ops at Barrière',
      body: "I put AI at the heart of product work: I automate what's repetitive in specification and documentation, so Product Managers can save their energy for decisions.",
      points: [
